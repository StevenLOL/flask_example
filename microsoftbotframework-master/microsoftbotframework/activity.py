...
class Activity(Response):
    def __init__(self, **kwargs):
        self.defaults = {
            ...
            'topicName': None,
            'type': None,
            # [contactRelationUpdate, conversationUpdate, deleteUserData, message, ping, typing, endOfConversation]
        }
    ...
    def fill(self, message, reply_to_activity=False):
        skip = ['timestamp', 'localTimestamp', 'entities', 'text', 'id', 'membersAdded', 'membersRemoved',
                'attachments']
